...
public class Login extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(un)
                    .addComponent(psw, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
        Connection con;  //connects mysql and java
        Statement stmt;  // loads username password etc
        PreparedStatement pstmt;// search query hold
        ResultSet rs; // executes and fetches data
        Class.forName("com.mysql.jdbc.Driver"); //loads the driver
        String str=("jdbc:mysql://localhost:3306/project");//path of db
        con=DriverManager.getConnection(str,"root","");// db,username,password
